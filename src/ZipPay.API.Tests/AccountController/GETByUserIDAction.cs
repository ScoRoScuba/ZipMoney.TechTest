...
{
    public class GETByUserIDAction
    {
        ...
        private const string UserAccountRequestUrl = "/users/1/accounts";

        public GETByUserIDAction()
        {
        ...
        [Fact]
        public void GETByUserIdReturnsAccountsForUSer()
        {
            ...
            _mockAccountService.Setup(a => a.GetUsersAccounts(It.IsAny<long>())).Returns(accounts);

            var result = _httpTestClient.GetAsync(UserAccountRequestUrl).Result;
